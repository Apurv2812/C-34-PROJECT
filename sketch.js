...
function setup() {
  ...
  box7 = new Box(830, 300, 70, 70);
  box8 = new Box(830, 400, 70, 70);
  ...
  box18 = new Box(830, 200, 70, 70);
  box19 = new Box(830, 300, 70, 70);
  box20 = new Box(830, 400, 70, 70);
  box21 = new Box(830, 400, 70, 70);
  box22 = new Box(830, 400, 70, 70);
